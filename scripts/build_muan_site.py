...
function show(i) {{
  ...
  if (p.installation_video) body += `<section class="section"><h3>安装视频</h3><video class="install-video" controls preload="metadata" playsinline src="${{esc(p.installation_video)}}"></video></section>`;
